...
public class MyHorizontalScrollView extends HorizontalScrollView implements OnClickListener {
	...
	private OnMyItemClickListener mOnClickListener;
	...
	public void initDatas(HorizontalScrollViewAdapter mAdapter) {
		...
		if (mChildWidth == 0 && mChildHeight == 0) {
			int w = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.AT_MOST, 1000);
			int h = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.AT_MOST, 1000);
			view.measure(w, h);
	...
	public void initFirstScreenChildren(int mCountOneScreen) {
		...
		mViewPos.clear();
		int size = (mCountOneScreen > mAdapter.getCount()) ? mAdapter.getCount() : mCountOneScreen;
	...
	public void setOnMyItemClickListener(OnMyItemClickListener onMyItemClickListener) {
		this.mOnClickListener = onMyItemClickListener;
	}
